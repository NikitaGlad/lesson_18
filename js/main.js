...
console.log(getLocalDay('2020-05-21')); // 4
console.log(getLocalDay('2020-06-08')); // 1
console.log(getLocalDay('2055-05-21')); // 5
...
let Car = function (engine, model, name, year) {
  ...
  let car = new Car(2500, 'Camry', 'Toyota', 2018);
  let car2 = new Car(5700, 'Ram 3500', 'Dodge', 2019);
